...
void CmptTraits::UnsafeRegisterOne() {
  ...
  if constexpr (details::CopyCtorWithAlloc<Cmpt>) {
    ...
    copy_constructors.emplace(type.GetID(), [](void* dst, const void* src,
                                               std::pmr::memory_resource*) {
...
void CmptTraits::RegisterOne() {
  ...
  static_assert(std::is_default_constructible_v<Cmpt> ||
                ...
                "<Cmpt> must be default-constructible or with alloc");
  static_assert(
