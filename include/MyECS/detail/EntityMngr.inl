...
const std::tuple<Cmpts*...> EntityMngr::EntityAttachWithoutInit(EntityData* e) {
  ...
  for (auto cmptID : srcCmptTypeSet) {
    ...
    RuntimeCmptTraits::Instance().MoveConstruct(cmptID, srcSize, dstCmpt,
                                                srcCmpt);
  }
...
// struct GenJob<TypeList<Args...>, TypeList<TaggedCmpts...>,
//               TypeList<OtherArgs...>> {
...
//          mngr->QueryArchetypes<ConcatedAll, ConcatedAny, ConcatedNone,
//                                CmptList>()) {
//       auto cmptsTupleVec =
//           archetype->Locate<CmptTag::RemoveTag_t<TaggedCmpts>...>();
...
//                 static_cast<TaggedCmpts>(
//                     (std::get<
//                          Find_v<CmptList, CmptTag::RemoveTag_t<TaggedCmpts>>>(
//                          cmptsTuple) +
//                      j))...,
//                 OtherArgs{}...))...);
//           }
