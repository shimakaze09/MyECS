...
template <typename TaggedCmpt>
static constexpr bool IsLastFrameSingleton_v =
    IsLastFrameSingleton<TaggedCmpt>::value;
...
template <typename TaggedCmpt>
static constexpr bool IsLatestSingleton_v =
    IsLatestSingleton<TaggedCmpt>::value;

template <typename TaggedCmpt>
struct IsSingleton : IValue<bool, IsLastFrameSingleton_v<TaggedCmpt> ||
...
template <typename TaggedCmpt>
struct IsNonSingleton
    : IValue<bool, IsLastFrame_v<TaggedCmpt> || IsWrite_v<TaggedCmpt> ||
...
static constexpr AccessMode AccessModeOf_default =
    IsLastFrame_v<T>
        ...
        : (IsWrite_v<T>
               ...
               : (IsLatest_v<T>
                      ? AccessMode::LATEST
                      : (IsLastFrameSingleton_v<T>
                             ? AccessMode::LAST_FRAME_SINGLETON
                             : (IsWriteSingleton_v<T>
...
template <typename Cmpt>
struct IsLastFrame<LastFrame<Singleton<Cmpt>>> : std::false_type {};

template <typename T>
struct IsWrite : std::false_type {};

template <typename Cmpt>
struct IsWrite<Write<Cmpt>> : std::true_type {};

template <typename Cmpt>
struct IsWrite<Write<Singleton<Cmpt>>> : std::false_type {};
...
template <typename Cmpt>
struct IsLatest<Latest<Cmpt>> : std::true_type {};

template <typename Cmpt>
struct IsLatest<Latest<Singleton<Cmpt>>> : std::false_type {};
...
template <typename Cmpt>
struct IsLastFrameSingleton<LastFrame<Singleton<Cmpt>>> : std::true_type {};

template <typename T>
struct IsWriteSingleton : std::false_type {};

template <typename Cmpt>
struct IsWriteSingleton<Write<Singleton<Cmpt>>> : std::true_type {};

template <typename Cmpt>
struct IsWriteSingleton<Singleton<Cmpt>> : std::true_type {};
