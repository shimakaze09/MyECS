...
template <typename Func>
SystemSchedule<type>& SystemSchedule<type>::Register(const std::string& name,
                                                     Func&& func) {
...
template <SysType type>
SystemSchedule<type>& SystemSchedule<type>::Order(std::string_view first,
...
struct Schedule<type, TypeList<TagedCmpts...>> {
  ...
  static void RegisterBefore(SystemSchedule<type>* sysSchedule,
  ...
  template <typename... Cmpts>
  static void RegisterAfter(SystemSchedule<type>* sysSchedule,
                            tf::Taskflow* system, TypeList<Cmpts...>) {
