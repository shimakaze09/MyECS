...
struct NoneGroup {
  ...
  NoneGroup(SystemFunc* func) : sysFuncs{func} {
    allTypes = SetUnion(func->entityQuery.filter.all,
                        func->entityQuery.locator.CmptAccessTypes());
...
unordered_map<CmptType, Schedule::CmptSysFuncs> Schedule::GenCmptSysFuncsMap()
    const {
