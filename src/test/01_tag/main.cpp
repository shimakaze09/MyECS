...
class DataSystem : public System {
 public:
  ...
  virtual void OnUpdate(Schedule& schedule) override {
    schedule
        .Register([](LastFrame<Data> d) { cout << "lastFrame_sys0" << endl; },
                  "lastFrame_sys0")
        .Register([](LastFrame<Data> d) { cout << "lastFrame_sys1" << endl; },
                  "lastFrame_sys1")
        ...
        .Register([](const Data* d) { cout << "latest_sys0" << endl; },
                  "latest_sys0")
        .Register([](const Data* d) { cout << "latest_sys1" << endl; },
                  "latest_sys1");
  }
};
