...
class DataSystem : public System {
 public:
  ...
  virtual void OnUpdate(Schedule& schedule) noexcept {
    schedule
        .Register([](Data1* d1, Data2* d2) { cout << "writer_sys0" << endl; },
                  "writer_sys0")
        .Register([](Data1* d) { cout << "writer_sys1" << endl; },
                  "writer_sys1")
        .Register([](Data2* d2) { cout << "writer_sys2" << endl; },
                  "writer_sys2")
        .Register([](Data1* d, Data2* d2) { cout << "writer_sys3" << endl; },
                  "writer_sys3")
