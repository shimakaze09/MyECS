...
struct DataSystem {
  static void OnUpdate(Schedule& schedule) {
    schedule.RegisterEntityJob(
        ...
        "Doublize",
        Schedule::EntityJobConfig{.changeFilter = {{TypeID_of<Data>}}});
  }
};
...
int main() {
  ...
  std::cout << "Data: " << w.entityMngr.ReadComponent<Data>(e)->value
            << std::endl
            << "DoubleData: "
            << w.entityMngr.ReadComponent<DoubleData>(e)->value << std::endl;
  w.Update();  // Doublize
  std::cout << "Data: " << w.entityMngr.ReadComponent<Data>(e)->value
            << std::endl
            << "DoubleData: "
